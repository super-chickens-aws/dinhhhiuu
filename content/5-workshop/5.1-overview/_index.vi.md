...
Trong workshop này, chúng ta sẽ xây dựng **Polly Voice**, một ứng dụng web chuyển đổi văn bản thành giọng nói (Text-to-Speech - TTS) theo kiến trúc cloud-native, sử dụng các công nghệ Serverless trên nền tảng Amazon Web Services (AWS).

Ứng dụng cho phép người dùng đăng nhập an toàn, chuyển đổi văn bản thành giọng nói tự nhiên bằng Amazon Polly, lưu trữ các tệp âm thanh được tạo trên Amazon S3 và quản lý lịch sử chuyển đổi thông qua Amazon DynamoDB.
...
Mỗi dịch vụ đảm nhiệm một chức năng riêng trong hệ thống và phối hợp với nhau để tạo thành một kiến trúc Serverless hoàn chỉnh.