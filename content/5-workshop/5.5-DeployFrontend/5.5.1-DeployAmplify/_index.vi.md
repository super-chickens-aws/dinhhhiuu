...
![Deploy an app](https://hieuthaihcmut.github.io/fcj-workshop-template/images/5-Workshop/5.4-DeployFrontend/deploy-an-app.png)
...
![GitHub](https://hieuthaihcmut.github.io/fcj-workshop-template/images/5-Workshop/5.4-DeployFrontend/selectGithub.png)
...
![Add repository](https://hieuthaihcmut.github.io/fcj-workshop-template/images/5-Workshop/5.4-DeployFrontend/addRepo.png)

5. Tại trang **App settings**, nhập `polly-voice` trong mục **App name**.

![App name](https://hieuthaihcmut.github.io/fcj-workshop-template/images/5-Workshop/5.4-DeployFrontend/appName.png)
...
```text
AWS CloudFormation → Stacks → polly-voice-api → Outputs → ApiUrl
```
...
![Review information](https://hieuthaihcmut.github.io/fcj-workshop-template/images/5-Workshop/5.4-DeployFrontend/checkinfo.png)
...
![Deployed](https://hieuthaihcmut.github.io/fcj-workshop-template/images/5-Workshop/5.4-DeployFrontend/result.png)
...
![Polly Voice website](https://hieuthaihcmut.github.io/fcj-workshop-template/images/5-Workshop/5.4-DeployFrontend/website.png)
