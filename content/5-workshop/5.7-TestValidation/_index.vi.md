...
Phần này xác nhận hệ thống Polly Voice hoạt động đúng sau khi frontend và backend được triển khai. Quá trình kiểm thử bao gồm gửi request, xem log, kiểm tra metric, thử các tình huống lỗi và đối chiếu kết quả thực tế với kết quả mong đợi.
