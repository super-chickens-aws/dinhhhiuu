...
Người dùng sẽ được xác thực thông qua **Amazon Cognito** trước khi gửi yêu cầu đến **API Gateway**. Sau đó, **AWS Lambda** sẽ xử lý yêu cầu, gọi **Amazon Polly** để tổng hợp giọng nói, lưu tệp âm thanh vào **Amazon S3**, ghi thông tin lịch sử vào **Amazon DynamoDB** và trả kết quả về cho ứng dụng frontend.
